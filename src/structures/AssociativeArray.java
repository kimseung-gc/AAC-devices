...
public class AssociativeArray<K, V> implements Iterable<KVPair<K, V>>{
  ...
  /**
   * Iterator for the `for` loop where as normally pairs are not accessible
   * by the users, the iterator makes it accessible, and this becomes handy
   * when implementing to get the keys/values only of the pairs.
   */
  public Iterator<KVPair<K, V>> iterator() {
    return new AssociativeArrayIterator<K, V>(this);
  } // iterator()
...
class AssociativeArrayIterator<K, V> implements Iterator<KVPair<K, V>>{
  ...
  /**
   * Variable that contains the size of the associative array
   */
  int len;

  /**
   * The array that contains the values in the associative array.
   */
  KVPair<K, V> temp[];
  ...
  } // AssociativeArrayIterator(AssociativeArray<K, V>)
